...
public:
	...
	TLE5012B(SoftSPI &conf, uint16_t miso, uint16_t mosi, uint16_t sck);
	...
	errorTypes begin(uint16_t miso, uint16_t mosi, uint16_t sck, int32_t cs);
	errorTypes begin(int32_t cs);
	errorTypes begin(SoftSPI &conf, uint16_t miso, uint16_t mosi, uint16_t sck, int32_t cs);
	errorTypes begin(SoftSPI &conf, uint16_t miso, uint16_t mosi, uint16_t sck, int32_t cs, SPISettings &settings);
